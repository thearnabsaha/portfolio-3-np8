    ...
    return (
        <div>
            ...
            <div className="icon">
                ...
                <a href=""><motion.div initial={{scale:0}} animate={{scale:[0,1,1.5,1],BackgroundColor:"#FCF6F4"}} transition={{type:'spring', duration:1, delay:1.6}}><YouTube className="yt ic" /></motion.div></a>
