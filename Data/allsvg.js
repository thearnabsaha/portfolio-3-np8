...
export const PowerBtn = (props) => {
  return (
    ...
    >
      <motion.path
        initial={{opacity:0, pathLength:0,pathOffset:0}} animate={{opacity:1, pathLength:1,pathOffset:1, transition:{duration:2,ease:'easeInOut'}}}
        fill={props.fill}
  ...
  return (
    ...
    >
      <motion.path
        ...
        initial={{pathLength:0}} animate={{pathLength:1, transition:{duration:10,ease:'easeInOut',pathLength: {type: "spring", duration: 1.5, bounce: 0 },}}}
      />
    </motion.svg>
  );
};
